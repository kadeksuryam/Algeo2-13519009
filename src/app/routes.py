...
#View function, main website
@app.route('/')
@app.route('/index.html')
def index():
    return render_template("index.html")

#Post search queries dari client
...
#Saat client memasukkan list of urls
...
#untuk redirect ke isi file/url
